            ...
            <div className="product-modal-content">
              ...
              <div className="product-modal-details">
                ...
                <div className="product-specs">
                  ...
                  <p>
                    <strong>Purity:</strong> {selectedProduct.purity}
                  </p>
                  <p>
                    <strong>Craftsmanship:</strong> Handcrafted Premium Finish
                  </p>
                  <p>
                    <strong>Availability:</strong> Available for Order
                  </p>
                </div>
              ...
              {cart.length === 0 ? (
                ...
                <div style={{ marginTop: "20px" }}>
                  ...
                  <div style={{ marginTop: "24px", textAlign: "right" }}>
                    <a
                      href={`https://wa.me/919878978787?text=Hi, I want to order these items: ${cart
                        .map((i) => i.name)
                        .join(", ")}`}
                      target="_blank"
                      rel="noopener noreferrer"
